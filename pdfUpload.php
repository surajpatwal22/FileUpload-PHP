            ...
            <div class="col-lg-4">
                <div class="card p-4">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <input type="file" name="fileToUpload" id="fileToUpload" accept=".pdf" require>
                        <input type="submit" value="Upload Image" name="submit">
                    </form>
                    <a href="pdf-files/2017-18.pdf"></a>
...
//    print_r( $_FILES["fileToUpload"]);  
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST["submit"])) {
            ...
            $target_dir = "pdf-files/" . $target_name;
            // echo $target_dir;
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "  <tr>
                                           ...
                                           <td>" . $row['designation'] . "</td>
                                             <td >    <a href='".$row['img_source']."' target=_blank > <span>file</span> </a>
                                                </tr>";
                                        $serno = $serno + 1;
